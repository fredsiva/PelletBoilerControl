...
/**
 * Fixed timeout issue (cast to int)
...
public class FTextMenu  
{
	 ...
	 */
	public FTextMenu( String[] items, int topRow)
	{
	 ...
	 */	
	public FTextMenu(String[] items, int topRow, String title)
	{
